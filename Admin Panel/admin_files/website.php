...
<head>
  ...
  <title>Website | WebRater.com</title>
  <!-- Bootstrap core CSS-->
              ...
              <tbody>
				...
				while($row=mysqli_fetch_assoc($rs)){
                    ...
                    <tr>
						...
						<td align="center"><a href="website_update.php?id=<?php echo $row['webid'] ?>"><img src="../images/edit.png"></a></td>
						<td align="center"><a href="website_delete.php?id=<?php echo $row['webid'] ?>"><img src="../images/delete.png"></a></td>
                    </tr>
					<?php
					$sl++;
				}
